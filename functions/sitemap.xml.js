...
const GUIDE_SLUGS = ["choose-browser-game","browser-game-performance","mobile-browser-gaming","puzzle-game-strategy","browser-racing-tips","keyboard-mouse-controls","two-player-browser-games","how-we-select-games"];
