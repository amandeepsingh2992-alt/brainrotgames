...
for (const id of ["7RU2YF", "011ODI", "ANMAR4"]) {
  assert(apiGames.includes(id), "catalogue", "Catalogue API blocklist is missing " + id);
  assert(apiGame.includes(id), "catalogue", "Single-game API blocklist is missing " + id);
  assert(playFn.includes(id), "catalogue", "Play route blocklist is missing " + id);
}
